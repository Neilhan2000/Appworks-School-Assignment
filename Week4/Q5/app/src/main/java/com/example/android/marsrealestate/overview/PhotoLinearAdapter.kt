...
class PhotoLinearAdapter(private val onclickListener: OnclickListener) : ListAdapter<MarsProperty, PhotoLinearAdapter.MarsPropertyViewHolder>(DiffCallback) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): PhotoLinearAdapter.MarsPropertyViewHolder {
